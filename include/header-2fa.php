...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand mr-4" href="/">
            <img src="/static-assets/img/brand-side.png" alt="Brand Logo" width="111.9px" height="40px">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            if (empty($_SESSION['user_id'])) {
                ...
                echo '<form action="/account/logout/" method="post">
                  <button type="submit" class="btn btn-outline-primary"><i class="fas fa-sign-out-alt"></i> ' . $lang['log-out'] . ' <span class="caret"></span></button>
