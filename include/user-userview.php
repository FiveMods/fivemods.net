...
if ($_SESSION['uuid'] == $uuid && $blocked == 0) {
   ...
   <circle class="edit-button-circle" cx="27" cy="27" r="26.5" fill="#AAE8B0" stroke="#13B955"/>
   ...
   <circle class="report-button-circle" cx="27" cy="27" r="26.5" fill="#FECACA" stroke="#B91C1C"/>
