...
?>
<!DOCTYPE html>
<html lang="en" dir="<?php if ($_COOKIE['language_preference'] == "IL") {
                            echo "rtl";
                        } else {
                            echo "ltr";
                        } ?>">
...
<head>
    ...
    <script>
        ...
        posthog.init('phc_qxU7T47EEzrtoEi4MYncOuECF5ksWCcpcrq1QqADhTD', {
...
<body class="bg">
    ...
    <noscript>
        <p><img src="//stats.fivemods.net/matomo.php?idsite=2&amp;rec=1" style="border:0;" alt="" /></p>
    </noscript>
    <!-- End Matomo Code -->
