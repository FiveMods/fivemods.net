...
<head>
    ...
    <link rel="icon" href="/static-assets/img/fivemods-favicon.png">
...
<body>
    <div class="flex-center position-ref full-height">
        <div class="center"><img src="/static-assets/img/brand-down.png" load="lazy" alt="Brand Logo" style="height: 75px;"></div>
    </div>
