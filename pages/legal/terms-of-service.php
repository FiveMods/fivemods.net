    ...
    <div class="container pt-md-4 pb-md-4 height-md-50">
        <div class="row">
            <div class="col-md-8 col-lg-7 col-xl-6">
                <h1 class="display-4"> <?php echo $lang['terms-of-service']; ?> </h1>
        ...
        <div class="col-md-8 col-lg-9">
            <article class="pb-2">
                ...
                <ul>
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FiveMods.net.</li>
                    <li><strong>Country</strong> refers to: Baden-Württemberg, Germany</li>
                    <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
                    <li><strong>Service</strong> refers to the Website.</li>
                    <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement is maintained by the <a href="/ref?rdc=https://www.privacypolicies.com/terms-conditions-generator/">Terms and Conditions Generator</a>.</li>
