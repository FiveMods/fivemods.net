...
<head>
    ...
    <link rel="stylesheet" href="/static-assets/css/error-document.css">
    ...
    <meta property="og:image" content="https://assets.fivemods.net/static-assets/img/svg/error/fivemods_error_503.svg">
...
<body>
    <main>
        <section class="error-container">
            <div class="error-fm-logo" ><a href="/"><img src="https://assets.fivemods.net/static-assets/img/svg/error/fivemods_error_proxy.svg" alt="FiveMods Proxy Error Logo"></a></div>
            <h3>Proxy or VPN service detected</h3>
            <p>You are not allowed to enter FiveMods.net via a VPN or proxy. Please refer to our system administrator if you think this is an error. Reach out via <a href="mailto:contact@fivemods.net">contact@fivemods.net</a>.</p>
        </section>
    </main>
</body>
</html>